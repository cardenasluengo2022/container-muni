...
class MunicipioController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($muni)) {
            return Redirect::route('voyager.municipios.edit', [$muni->id]);
        }else{
            return Redirect::route('voyager.municipios.create');
        }
    }
