...
class ConfiguracionSitioController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    {
        $configSitio = ConfiguracionSitio::first();

        if (isset($configSitio)) {
            return Redirect::route('voyager.configuracion-sitios.edit', [$configSitio->id]);
            //return redirect()->action([ConfiguracionSitioController::class, 'edit']);
        }else{
            return Redirect::route('voyager.configuracion-sitios.create');
