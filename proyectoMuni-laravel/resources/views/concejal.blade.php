          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <h2 class="entry-title">
                <a href="/concejal/{{$concejal->slug}}">{{$concejal->titulo_redaccion}}</a>
              </h2>
                    ...
                    <a href="#">
                      <time datetime="2020-01-01">
                        <?php date_default_timezone_set('Europe/Madrid'); setlocale(LC_TIME, 'es_ES.UTF-8'); ?>
                          {{ \Carbon\Carbon::parse($concejal->created_at)->formatLocalized('%d de %B del %Y') }} 
                          a las {{ \Carbon\Carbon::parse($concejal->created_at)->formatLocalized('%H:%M') }}
                      </time>
                  </a>
                </li>
                </ul>
